...
def detect_indentation(
    ...
    """
    Estimate indentation relative to the page's main left margin.
    """
...
def detect_table_like(
    ...
    """
    Detect whether a block has evidence of tabular alignment.
    """
...
def analyze_page_layout(page: Page) -> None:
    """
    Calculate non-semantic layout signals for a page.
    """
    ...
    for block in blocks:
        ...
        block.layout.is_list_like = (
            detect_list_like(block)
        )
    ...
    # Determine coarse columns.
    #
    # We deliberately use a simple geometric split here.
    # Semantic column interpretation comes later.
